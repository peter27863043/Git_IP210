...
#define IP210RegWrite(_Dest, _data)     *(volatile u8_t xdata *)(_Dest) = _data
#define IP210RegRead(_Src) (*(volatile u8_t xdata *)(_Src))

#define IP210RegRead16(SrcReg_) ( ( (u16_t)IP210RegRead(SrcReg_+1)<<8 ) | IP210RegRead(SrcReg_) )
#define IP210RegWrite16(DestReg_, data_) \
    *(volatile u8_t xdata *)(DestReg_) = (data_&0xff);\
    *(volatile u8_t xdata *)(DestReg_+1) = (data_>>8)
...
sfr P4=0xE8;
sfr OUTPUTEN=0xDA;
sbit FLASH_ADDR_19	= P4^1;
sbit FLASH_ADDR_20 	= P4^6;
//sfr PCON  = 0x87;
...
#define FCR_RX_FIFO_THRESHOLD                       0xFC
