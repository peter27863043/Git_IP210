...
SFILENAME code files_table12[] = {
	{"uart.htm",			uart_htm_file,	  sizeof(uart_htm_file),	0},
	{"cgi/uart.cgi",        NULL,             NULL,                     1},	
	{ NULL,                 NULL,             NULL,                    	NO_EX_FUNC},
};
//*************CGI service function table*********
CGI_FUNC_T code cgi_table12[] = {
	{ssi_uart,    			uart_htm_tags}, 
	{cgi_uart,    			NULL},        
	{NULL,        			NULL},
};

struct html_tags  uart_htm_tags_Buffer =  { 0, 0 }; 
...
{
		uart_htm_tags_Buffer.pos 	=uart_htm_tags[index].pos;
		uart_htm_tags_Buffer.varid=	uart_htm_tags[index].varid;
		return uart_htm_tags_Buffer;
