...
//peter 0x00 disable 0x01 tcp server mode, 0x02 tcp client , 0x03 udp Normal mode , 0x04 udp Listen Mode
...
"",\
"","GPIO 10",\
"limitied temperature -","GPIO 10 body"
