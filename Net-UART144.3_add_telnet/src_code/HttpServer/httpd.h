...
#define ERRORMSG_EEP            3
#define ERRORMSG_CHALLENGE      4
#define ERRORMSG_SETNO          5
#define ERRORMSG_SETOK          6
#define ERRORMSG_TIMEOUT        7
#define ERRORMSG_RESET          8
#define ERRORMSG_NOIP           9
#define ERRORMSG_WAIT0			10
#define ERRORMSG_WAIT1			11
#define ERRORMSG_WAIT2			12
#define ERRORMSG_WAIT3			13
#define ERRORMSG_WAIT4			14
#define ERRORMSG_WAIT5			15
#define ERRORMSG_WAIT6			16 
#define ERRORMSG_NOSERVICE      17
...
#ifdef DIS_COOKIE
#define DEF_PAGE "index.htm"
#else
#define DEF_PAGE "login.htm"
#endif
#endif 
