...
//******joe debug for router cookie find different form 20081222
		ptr=strfind(hs->INpacket.Cookie_item,"ICPlusCookie");
		ptr-=12;	
        hs->INpacket.Cookie_item = ptr;
//**************************************************************
		ptr=NULL;
...
*               
*******************************************************************************/
extern u8_t m_ReGetScalerData;	
extern eSCALER_ST m_eScaler_State;

void httpd_login_pass()
{
	if(m_eScaler_State>eScaler_Init_Info)
	    m_ReGetScalerData=1;
