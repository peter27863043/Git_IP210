...
echo #define MODULE_DIDO >>..\..\src_code\include\image_mode.h
...
echo #define MODULE_TCP_DIDO>>..\..\src_code\include\image_mode.h
...
call Cod2c.bat
cd ..\..\Project\WebCtrl_flash
c:\keil\uv2\uv2 %1 IP210WebCtrl.Uv2
cd exe
ren NETUART.BIN flash_512.bin
ren NETUARTAPP.BIN flash_app.bin
cd ..
